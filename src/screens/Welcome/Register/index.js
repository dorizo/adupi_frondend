...
export default function Register({ handleNext, values, step }) {
  return (
    <>
      ...
      {step === 5 && <Step5 values={values} handleNext={handleNext} />}
      {step === 6 && <Step6 values={values} handleNext={handleNext} />}
    </>
  );
}
Register.propTypes = {
