...
import { GET_ANALISA_V2_MITRA_PEMBELIAN, GET_ANALISI_PEMBELIAN_PEKERJA_PERBULAN } from '../../../api/report';
...
export default function TotalMitravsJumlahPembelian() {
  ...
  const { data : mitrapembelian, isLoading:lodingmitrapembelian, refetch:refetchmitrapembelian } = useQuery(['GET_ANALISA_V2_MITRA_PEMBELIAN', tahun?.value], () =>
  GET_ANALISA_V2_MITRA_PEMBELIAN(tahun?.value)
  );
