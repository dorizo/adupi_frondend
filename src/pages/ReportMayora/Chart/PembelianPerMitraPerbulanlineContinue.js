...
import { GET_PEMBELIAN_MITRA_PERBULAN, GET_PEMBELIAN_MITRA_PERBULANLINE, GET_PEMBELIAN_MITRA_PERBULANLINECONTINUES, GET_PENJUALAN_MITRA_PERBULANLINE, GET_PENJUALAN_MITRA_PERBULANLINECONTINUES } from '../../../api/report';
...
export default function PembelianPerMitraPerbulanLineContinue({ type = 'line' }) {
  ...
  const { data, isLoading, refetch } = useQuery(['GET_BELIAN_MITRA_PERBULANLINECONTINUE', tahun?.value], () =>
  GET_PEMBELIAN_MITRA_PERBULANLINECONTINUES(tahun?.value, mitraCode?.value)
  );
