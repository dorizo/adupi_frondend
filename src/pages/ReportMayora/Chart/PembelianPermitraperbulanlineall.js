...
import { GET_PEMBELIAN_MITRA_PERBULAN, GET_PEMBELIAN_MITRA_PERBULANLINE } from '../../../api/report';
import AutoCompleteLoading from '../../../components/AutoCompleteLoading';
import { yearOption } from '../../../utils/yearOption';

const tahunSekarang = new Date().getFullYear();

export default function PembelianPerMitraPerbulanlinejs({ type = 'line' }) {
  ...
  const { data, isLoading, refetch } = useQuery(['GET_PEMBELIAN_MITRA_PERBULANLINEALL', tahun?.value], () =>
    GET_PEMBELIAN_MITRA_PERBULANLINEALL(tahun?.value, mitraCode?.value)
  );
  const { data: mitraData } = useQuery('GET_MITRA_ALL_BY_SU_YESALL', GET_MITRA_ALL_BY_SU_YES);
