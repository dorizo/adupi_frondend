...
import { GET_LUAS_GUDANG_PERBULAN, GET_LUAS_GUDANG_PERBULANFASILITAOTOR } from '../../../api/report';
...
export default function LuasGudangPerbulan() {
  ...
  const { data, isLoading, refetch } = useQuery(['GET_LUAS_GUDANG_PERBULANFASILITATOR', tahun?.value], () =>
    GET_LUAS_GUDANG_PERBULANFASILITAOTOR(tahun?.value, sessionStorage.getItem("kordinator"))
  );
