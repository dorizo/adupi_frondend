...
import { GET_ANALISA_V2_CONTINUE_MITRA_PEMBELIAN, GET_ANALISA_V2_CONTINUE_MITRA_PENJUALAN, GET_ANALISA_V2_CONTINUE_MITRA_PENJUALANFASILITATOR, GET_ANALISI_PEMBELIAN_PEKERJA_PERBULAN } from '../../../api/report';
...
export default function Totalcontinuevspenjualan() {
  ...
  const { data : mitrapembelian, isLoading:lodingmitrapembelian, refetch } = useQuery(['GET_ANALISA_V2_CONTINUE_MITRA_PENJUALAN', tahun?.value], () =>
  GET_ANALISA_V2_CONTINUE_MITRA_PENJUALANFASILITATOR(tahun?.value , sessionStorage.getItem("kordinator"))
  );
