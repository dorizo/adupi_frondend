...
import { GET_ANALISA_V2_MITRA_PEMBELIAN, GET_ANALISA_V2_MITRA_PEMBELIANFASILITATOR, GET_ANALISI_PEMBELIAN_PEKERJA_PERBULANFASILITATOR } from '../../../api/report';
import AutoCompleteLoading from '../../../components/AutoCompleteLoading';
import { yearOption } from '../../../utils/yearOption';

const tahunSekarang = new Date().getFullYear();

export default function TotalMitravsJumlahPembelian() {
  ...
  const { data : mitrapembelian, isLoading, refetch:refetchmitrapembelian } = useQuery(['GET_ANALISA_V2_MITRA_PEMBELIANFASILITATOR', tahun?.value], () =>
  GET_ANALISA_V2_MITRA_PEMBELIANFASILITATOR(tahun?.value,sessionStorage.getItem("kordinator"))
  );
