...
import { GET_ANALISA_V2_CONTINUE_MITRA_PEMBELIAN, GET_ANALISA_V2_CONTINUE_MITRA_PEMBELIANFASILITATOTR, GET_ANALISI_PEMBELIAN_PEKERJA_PERBULAN } from '../../../api/report';
...
export default function Totalcontinuevspembelian() {
  ...
  const { data : mitrapembelian, isLoading:lodingmitrapembelian, refetch:refetchmitrapembelian } = useQuery(['GET_ANALISA_V2_CONTINUE_MITRA_PEMBELIANFASILITATOR', tahun?.value], () =>
  GET_ANALISA_V2_CONTINUE_MITRA_PEMBELIANFASILITATOTR(tahun?.value,sessionStorage.getItem("kordinator"))
  );
