...
import { GET_PEMBELIAN_MITRA_PERBULANLINE, GET_PEMBELIAN_MITRA_PERBULANLINEFAS } from '../../../api/report';
import AutoCompleteLoading from '../../../components/AutoCompleteLoading';
import { yearOption } from '../../../utils/yearOption';

const tahunSekarang = new Date().getFullYear();

export default function PembelianPerMitraPerbulanline({ type = 'line' }) {
  ...
  const { data, isLoading, refetch } = useQuery(['GET_PEMBELIAN_MITRA_PERBULANLINEFAS', tahun?.value], () =>
    GET_PEMBELIAN_MITRA_PERBULANLINEFAS(tahun?.value, mitraCode?.value, sessionStorage.getItem("kordinator"))
  );
