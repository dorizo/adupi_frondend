...
import { GET_PENJUALAN_MITRA_PERBULANLINECONTINUES, GET_PENJUALAN_MITRA_PERBULANLINECONTINUESFASILITATOR } from '../../../api/report';
...
export default function PenjualanPerMitraPerbulanLineContinue({ type = 'line' }) {
  ...
  GET_PENJUALAN_MITRA_PERBULANLINECONTINUESFASILITATOR(tahun?.value, mitraCode?.value, sessionStorage.getItem("kordinator"))
  );
