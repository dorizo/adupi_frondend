...
import { GET_PENJUALAN_SEMUA_MITRA_PERBULAN, GET_PENJUALAN_SEMUA_MITRA_PERBULANFASILITATOR } from '../../../api/report';
...
export default function PenjualanMitraPerbulan() {
  ...
  const { data, isLoading, refetch } = useQuery(['GET_PENJUALAN_SEMUA_MITRA_PERBULANFASILITATOR', tahun?.value], () =>
  GET_PENJUALAN_SEMUA_MITRA_PERBULANFASILITATOR(tahun?.value,sessionStorage.getItem("kordinator"))
  );
